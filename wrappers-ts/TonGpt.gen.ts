...
export const TonGptStorage = {
    ...
    store(self: TonGptStorage, b: c.Builder): void {
        ...
        b.storeUint(self.deploySeed, 32);
    },
...
/**
 > struct TonGptModelStatus {
 >     byteEmbeddings: uint16
 >     positionEmbeddings: uint16
 >     pairEmbeddings: uint16
 >     tokenEmbeddings: uint16
 >     heads: uint16
 >     tokenBytes: uint16
 >     isReady: bool
 > }
 */
export interface TonGptModelStatus {
    readonly $: 'TonGptModelStatus'
    byteEmbeddings: uint16
    positionEmbeddings: uint16
    pairEmbeddings: uint16
    tokenEmbeddings: uint16
...
export const TonGptModelStatus = {
    create(args: {
        byteEmbeddings: uint16
        positionEmbeddings: uint16
        pairEmbeddings: uint16
    ...
    fromSlice(s: c.Slice): TonGptModelStatus {
        return {
            $: 'TonGptModelStatus',
            byteEmbeddings: s.loadUintBig(16),
            positionEmbeddings: s.loadUintBig(16),
            pairEmbeddings: s.loadUintBig(16),
            tokenEmbeddings: s.loadUintBig(16),
            heads: s.loadUintBig(16),
            tokenBytes: s.loadUintBig(16),
            isReady: s.loadBoolean(),
        }
    },
    store(self: TonGptModelStatus, b: c.Builder): void {
        b.storeUint(self.byteEmbeddings, 16);
        b.storeUint(self.positionEmbeddings, 16);
        b.storeUint(self.pairEmbeddings, 16);
        b.storeUint(self.tokenEmbeddings, 16);
        b.storeUint(self.heads, 16);
        b.storeUint(self.tokenBytes, 16);
        b.storeBit(self.isReady);
    },
    toCell(self: TonGptModelStatus): c.Cell {
        return makeCellFrom<TonGptModelStatus>(self, TonGptModelStatus.store);
    }
}
...
export class TonGpt implements c.Contract {
    static CodeCell = c.Cell.fromBase64('');
    ...
    async getModelStatus(provider: ContractProvider): Promise<TonGptModelStatus> {
        const r = StackReader.fromGetMethod(7, await provider.get('modelStatus', []));
        return ({
            $: 'TonGptModelStatus',
            byteEmbeddings: r.readBigInt(),
            positionEmbeddings: r.readBigInt(),
            pairEmbeddings: r.readBigInt(),
            tokenEmbeddings: r.readBigInt(),
            heads: r.readBigInt(),
            tokenBytes: r.readBigInt(),
